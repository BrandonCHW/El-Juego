...
function CenterBoard({ name, hand}) {
    ...
    return (
        <>
            <div>
                ...
                isSelectedCard={selectedCard.key === 1} isCenterCard/> 
                <Card 
                key={2} 
                value={100} 
                onClick={(event) => handleClick(event, {key: 2, value: 100})} 
                isSelectedCard={selectedCard.key === 2} isCenterCard/>
            ...
            <div>
                ...
                isSelectedCard={selectedCard.key === 3} isCenterCard/> 
                <Card 
                key={4} 
                value={100} 
                onClick={(event) => handleClick(event, {key: 4, value: 100})} 
                isSelectedCard={selectedCard.key === 4} isCenterCard/> 
